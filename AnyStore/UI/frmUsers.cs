...
namespace AnyStore.UI
{
    public partial class frmUsers : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                MessageBox.Show("ทำการบันทึกข้อมูลผู้ใช้งานเรียบร้อยแล้ว");
                clear();
            }
            else
            {
                MessageBox.Show("ไม่สามารถทำการบันทึกข้อมูลผู้ใช้งานได้! กรุณาลองใหม่อีกครั้ง");
            }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                MessageBox.Show("ทำการเปลี่ยนแปลงข้อมูลผู้ใช้งานเรียบร้อยแล้ว");
                clear();
            }
            else
            {
                MessageBox.Show("ไมสามารถทำการเปลี่ยนแปลงข้อมูลผู้ใช้งานได้! กรุณาลองใหม่อีกครั้ง");
            }
            DataTable dt = dal.Select();
            dgvUsers.DataSource = dt;
        }
